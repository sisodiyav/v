...
$mail = send-mailmessage -From vishal.sisodiya@shearman.com -To vishal.sisodiya@shearman.com -Subject "$($user) $($stats.PercentComplete) % ExO move' -Body 'body" -SmtpServer 'am-smtp.shearman.com' 
