...
Write-host "Total number of Apps found: $($AllAssignedApps.DisplayName.Count)" -ForegroundColor cyan
"Total number of Apps found: $($AllAssignedApps.DisplayName.Count)" | Out-File -FilePath C:\Users\vs96430\Documents\group3.csv -Append -NoClobber

Write-host "Total number of Device Compliance policies found: $($AllDeviceCompliance.DisplayName.Count)" -ForegroundColor cyan
"Total number of Device Compliance policies found: $($AllDeviceCompliance.DisplayName.Count)" | Out-File -FilePath C:\Users\vs96430\Documents\group3.csv -Append -NoClobber

Write-host "Total number of Device Configurations found: $($AllDeviceConfig.DisplayName.Count)" -ForegroundColor cyan
"Total number of Device Configurations found: $($AllDeviceConfig.DisplayName.Count)" | Out-File -FilePath C:\Users\vs96430\Documents\group3.csv -Append -NoClobber

Write-host "Total number of Device Configurations Powershell Scripts found: $($AllDeviceConfigScripts.DisplayName.Count)" -ForegroundColor cyan
"Total number of Device Configurations Powershell Scripts found: $($AllDeviceConfigScripts.DisplayName.Count)" | Out-File -FilePath C:\Users\vs96430\Documents\group3.csv -Append -NoClobber
