...
Function New-CleanO365Session {
	...
	Connect-ExchangeOnline -UserPrincipalName p-svc-psd-agent@quadreal.com 
...
# Main Script
####################
$CredentialName = 'p-svc-psd-agent'
...
$reportrecipient = "mikehill@bighiller.com"
 $mailConfig = @{
        SMTPServer = "smtp.office365.com"
        SMTPPort = "587"
        Sender = "p-svc-psd-agent@quadreal.com"
        Recipients = $reportrecipient
        Header = "QuadReal Exchange Online Mobile Device Partnership Report"
    }
